       ...
       <a-modal
        ...
        >
            <a-form ref="form" :model="formState" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-form-item name="creator" label="创建者openid">
                <a-input v-model:value="formState.openid" />
              </a-form-item>
              <a-form-item name="title" label="tx">
                <!-- <a-select v-model:value="formState.title" placeholder="商品标题">
                  <a-select-option value="shanghai">Zone one</a-select-option>
                  <a-select-option value="beijing">Zone two</a-select-option>
                </a-select> -->
                <a-input v-model:value="formState.helperavatars" />
              </a-form-item>
